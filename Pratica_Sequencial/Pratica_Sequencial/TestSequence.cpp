...
void testAll()
{
    ...
    sequence->insertEnd("l"); // era insertBegin("l")
    sequence->insertEnd("m"); // era insertBegin("m")
    sequence->insertEnd("n"); // era insertBegin("n")
...
void testRemoveEnd()
{
    ...
    sequence->insertEnd("c"); // era insertBegin("c")
    assert( sequence->getQuantity() == 2 );
    assert( sequence->get(1) == "b" );
    assert( sequence->get(2) == "c" );
